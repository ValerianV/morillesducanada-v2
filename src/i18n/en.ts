export const en = {
  ...
  professional: {
    ...
    preorderDesc: "Reserve your batch before the harvest. Direct purchase from foragers, on-site drying, vacuum-sealed shipment. Choose your variety: brown, blonde, grey or green. Lead time: 6 to 8 weeks after confirmation.<br><strong>Brown: €360/kg · Blonde, grey, green: €390/kg</strong> (5 kg+: volume pricing)<br>Minimum order: 1 kg per variety.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Do you deliver outside France?", a: "Yes! We deliver to mainland France, Belgium, Luxembourg, Switzerland, and across the European Union. Free shipping from €80 for France and from €100–120 for other destinations. For large professional orders, contact us directly." },
