export const fr = {
  ...
  origin: {
    ...
    p2: "Contrairement aux morilles cultivées en serre ou aux variétés européennes, les morilles de feu développent un <strong>profil aromatique unique</strong> : des notes fumées intenses, une profondeur boisée et une texture charnue que seul le passage du feu peut conférer. On y trouve quatre familles — brunes (<em>M. conica, M. brunnea, M. snyderi</em>), blondes (<em>M. americana, M. esculenta, M. prava</em>), grises (<em>M. tomentosa</em>) et vertes (<em>M. sextelata, M. septimelata</em>) — chacune avec ses nuances.",
