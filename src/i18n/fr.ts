export const fr = {
  ...
  professional: {
    ...
    preorderDesc: "Réservez votre lot avant la cueillette. Achat direct aux cueilleurs, séchage sur place, expédition sous vide. Choix de la variété : brune, blonde, grise ou verte. Délai : 6 à 8 semaines après confirmation.<br><strong>Brune : 360 €/kg · Blonde, grise, verte : 390 €/kg</strong> (5 kg+ : tarif dégressif)<br>Commande minimum : 1 kg par variété.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Livrez-vous en dehors de la France ?", a: "Oui ! Nous livrons en France métropolitaine, en Belgique, au Luxembourg, en Suisse et dans toute l'Union Européenne. La livraison est offerte dès 80 € pour la France, et dès 100 à 120 € pour les autres destinations. Pour des commandes professionnelles importantes, contactez-nous directement." },
